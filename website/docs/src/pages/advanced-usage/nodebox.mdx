...
To set up Nodebox, first add an `<iframe>` to your browser element. This will provide a reference to where the application's preview will be rendered.
...
This will Initialize a new Nodebox instance and link that instance to the preview element.
...
Check out this [Nodebox example starter](https://codesandbox.io/p/sandbox/young-microservice-hgpbfd) and happy coding!