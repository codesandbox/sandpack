...
const clipboardIcon = `<svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#a)">
  <path d="M9.787.97H3.094c-.613 0-1.115.527-1.115 1.17v8.188h1.115V2.14h6.693V.97Zm1.673 2.34H5.325c-.613 0-1.115.527-1.115 1.17v8.188c0 .643.502 1.17 1.115 1.17h6.135c.613 0 1.115-.527 1.115-1.17V4.48c0-.643-.502-1.17-1.115-1.17Zm0 9.358H5.325V4.48h6.135v8.188Z" fill="#fff"/>
</g>
<defs>
  <clipPath id="a">
    <path fill="#fff" transform="translate(.465 .213)" d="M0 0h13.624v13.624H0z"/>
  </clipPath>
</defs>
</svg>`;
