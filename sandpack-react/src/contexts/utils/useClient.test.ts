...
describe(useClient, () => {
  ...
  describe("status", () => {
    ...
    it("returns the initial state, after register a bundler", () => {
      const { result } = renderHook(() =>
        useClient({}, getSandpackStateFromProps({}))
      );
    ...
    it("returns the running state, after init client", () => {
      const { result } = renderHook(() =>
        useClient({}, getSandpackStateFromProps({}))
      );
      const operations = result.current[1];
    ...
    it("returns the idle state, after unmounting client", () => {
      const { result } = renderHook(() =>
        useClient({}, getSandpackStateFromProps({}))
      );
      const operations = result.current[1];
    ...
    it("keeps running if it unmounts a client and there's still another one running", () => {
      const { result } = renderHook(() =>
        useClient({}, getSandpackStateFromProps({}))
      );
      const operations = result.current[1];
