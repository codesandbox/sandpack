...
const CustomLayout: React.FC = () => {
  ...
  useEffect(() => {
    updateCode(
      "export default function App() { return <div>Updated Code</div>; }"
    );
  }, []);
...
export const SetCustomCodeInEffect: React.FC = () => {
  return (
    <SandpackProvider
      options={{
        activeFile: "/App.js",
      ...
      files={{
        "/App.js":
          "export default function App() { return <div>Default Code</div>; }",
      }}
      template="react"
    >
      <CustomLayout />
